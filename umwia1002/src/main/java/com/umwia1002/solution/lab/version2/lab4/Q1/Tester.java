package com.umwia1002.solution.lab.version2.lab4.Q1;
...
public class Tester {
    ...
    private static void performOperation(String operation, LinkedList<Integer> list, Consumer<LinkedList<Integer>> consumer) {
