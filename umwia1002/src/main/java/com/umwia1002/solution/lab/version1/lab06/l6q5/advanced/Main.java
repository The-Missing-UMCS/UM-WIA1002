package com.umwia1002.solution.lab.version1.lab06.l6q5.advanced;

import com.umwia1002.solution.lab.version1.lab06.l6q5.advanced.service.GameService;
import com.umwia1002.solution.lab.version1.lab06.l6q5.advanced.service.GameServiceFactory;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (STEPWISE.equals(ans)) {
                    ...
                    System.out.println(
                        "Stepwise mode " + ((GlobalTracer.isIsStepwiseModeOn()) ? "On" : "Off"));
                    continue;
                }
                ...
                if (COMMENT.equals(ans)) {
                    ...
                    System.out.println(
                        "Comment mode " + ((GlobalTracer.isIsCommentModeOn()) ? "On" : "Off"));
                    continue;
                }
                ...
                if (!isValidInput(ans)) {
                    System.out.printf(
                        "Invalid input: %s. Please enter an integer value between 1 and 4.\n", ans);
                    continue;
                }
