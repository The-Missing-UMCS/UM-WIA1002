package com.umwia1002.solution.lab.version2.lab1.Q4.version1;

import com.umwia1002.solution.lab.version2.lab1.Q4.version1.characters.*;
...
public class Banner {
    ...
    public void print(String message) {
        ...
        message.chars()
            .forEach(ch -> {
                char c = (char) ch;
                ConsoleCharacter character = Character.isWhitespace(c) ? COLLECTIONS[26] : COLLECTIONS[getPos(c)];
