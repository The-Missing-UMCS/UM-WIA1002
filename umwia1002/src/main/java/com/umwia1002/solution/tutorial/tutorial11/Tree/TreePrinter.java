...
public class TreePrinter {
    // Reference: https://stackoverflow.com/questions/4965335/how-to-print-binary-tree-diagram-in-java/8948691#8948691
    ...
    // Approach 2
    public static <E extends Comparable<E>> void print(String prefix,
                                                       TreeNode<E> n,
                                                       boolean isLeft) {
        if (n != null) {
    ...
    public static <E extends Comparable<E>> void printNodeInternal(List<TreeNode<E>> nodes,
                                                                   int level,
                                                                   int height) {
